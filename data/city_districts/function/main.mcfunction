...
# Gray
tag @e[type=item,nbt={Item:{id:"minecraft:light_gray_banner"}},tag=!cd_gray,tag=!global.ignore,sort=nearest,limit=1] add cd_gray
execute as @e[type=item,nbt={Tags:[cd_gray],Item:{tag:{display:{}}}}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_gray,tag=!global.ignore] run function city_districts:cities/gray/found_district_gray
...
# Dark Green
tag @e[type=item,nbt={Item:{id:"minecraft:green_banner"}},tag=!cd_dark_green,tag=!global.ignore,sort=nearest,limit=1] add cd_dark_green
execute as @e[type=item,nbt={Tags:[cd_dark_green],Item:{tag:{display:{}}}}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_dark_green,tag=!global.ignore] run function city_districts:cities/dark_green/found_district_dark_green
...
# Dark Aqua
tag @e[type=item,nbt={Item:{id:"minecraft:cyan_banner"}},tag=!cd_dark_aqua,tag=!global.ignore,sort=nearest,limit=1] add cd_dark_aqua
execute as @e[type=item,nbt={Tags:[cd_dark_aqua],Item:{tag:{display:{}}}}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_dark_aqua,tag=!global.ignore] run function city_districts:cities/dark_aqua/found_district_dark_aqua
...
# Dark Red 
tag @e[type=item,nbt={Item:{id:"minecraft:red_banner"}},tag=!cd_dark_red,tag=!global.ignore,sort=nearest,limit=1] add cd_dark_red
execute as @e[type=item,nbt={Tags:[cd_dark_red],Item:{tag:{display:{}}}}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_dark_red,tag=!global.ignore] run function city_districts:cities/dark_red/found_district_dark_red
...
# Dark Purple
tag @e[type=item,nbt={Item:{id:"minecraft:purple_banner"}},tag=!cd_dark_purple,tag=!global.ignore,sort=nearest,limit=1] add cd_dark_purple
execute as @e[type=item,nbt={Tags:[cd_dark_purple],Item:{tag:{display:{}}}}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_dark_purple,tag=!global.ignore] run function city_districts:cities/dark_purple/found_district_dark_purple
...
# Green
tag @e[type=item,nbt={Item:{id:"minecraft:lime_banner"}},tag=!cd_green,tag=!global.ignore,sort=nearest,limit=1] add cd_green
execute as @e[type=item,nbt={Tags:[cd_green],Item:{tag:{display:{}}}}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_green,tag=!global.ignore] run function city_districts:cities/green/found_district_green
...
# Aqua
tag @e[type=item,nbt={Item:{id:"minecraft:light_blue_banner"}},tag=!cd_aqua,tag=!global.ignore,sort=nearest,limit=1] add cd_aqua
execute as @e[type=item,nbt={Tags:[cd_aqua],Item:{tag:{display:{}}}}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_aqua,tag=!global.ignore] run function city_districts:cities/aqua/found_district_aqua
...
# Light Purple (Pink)
tag @e[type=item,nbt={Item:{id:"minecraft:pink_banner"}},tag=!cd_light_purple,tag=!global.ignore,sort=nearest,limit=1] add cd_light_purple
execute as @e[type=item,nbt={Tags:[cd_light_purple],Item:{tag:{display:{}}}}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_light_purple,tag=!global.ignore] run function city_districts:cities/light_purple/found_district_light_purple
...
# Yellow
tag @e[type=item,nbt={Item:{id:"minecraft:yellow_banner"}},tag=!cd_yellow,tag=!global.ignore,sort=nearest,limit=1] add cd_yellow
execute as @e[type=item,nbt={Tags:[cd_yellow],Item:{tag:{display:{}}}}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_yellow,tag=!global.ignore] run function city_districts:cities/yellow/found_district_yellow
...
# Gold
tag @e[type=item,nbt={Item:{id:"minecraft:orange_banner"}},tag=!cd_gold,tag=!global.ignore,sort=nearest,limit=1] add cd_gold
execute as @e[type=item,nbt={Tags:[cd_gold],Item:{tag:{display:{}}}}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_gold,tag=!global.ignore] run function city_districts:cities/gold/found_district_gold
