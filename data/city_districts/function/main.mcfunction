...
execute as @e[type=item,nbt={Tags:[cd_gray]}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_gray,tag=!global.ignore] run function city_districts:cities/gray/found_district_gray
...
execute as @e[type=item,nbt={Tags:[cd_dark_green]}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_dark_green,tag=!global.ignore] run function city_districts:cities/dark_green/found_district_dark_green
...
execute as @e[type=item,nbt={Tags:[cd_dark_aqua]}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_dark_aqua,tag=!global.ignore] run function city_districts:cities/dark_aqua/found_district_dark_aqua
...
execute as @e[type=item,nbt={Tags:[cd_dark_red]}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_dark_red,tag=!global.ignore] run function city_districts:cities/dark_red/found_district_dark_red
...
execute as @e[type=item,nbt={Tags:[cd_dark_purple]}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_dark_purple,tag=!global.ignore] run function city_districts:cities/dark_purple/found_district_dark_purple
...
execute as @e[type=item,nbt={Tags:[cd_green]}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_green,tag=!global.ignore] run function city_districts:cities/green/found_district_green
...
execute as @e[type=item,nbt={Tags:[cd_aqua]}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_aqua,tag=!global.ignore] run function city_districts:cities/aqua/found_district_aqua
...
execute as @e[type=item,nbt={Tags:[cd_light_purple]}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_light_purple,tag=!global.ignore] run function city_districts:cities/light_purple/found_district_light_purple
...
execute as @e[type=item,nbt={Tags:[cd_yellow]}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_yellow,tag=!global.ignore] run function city_districts:cities/yellow/found_district_yellow
...
execute as @e[type=item,nbt={Tags:[cd_gold]}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_gold,tag=!global.ignore] run function city_districts:cities/gold/found_district_gold
