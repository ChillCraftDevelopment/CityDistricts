...
tellraw @e[type=player,distance=..1000] [{"text":"[CD] ","color":"dark_aqua"},{"selector":"@n[type=armor_stand, tag=cd_dist_dark_aqua]","color":"dark_aqua"}, {"text":" has been discontinued... ","color":"dark_aqua"}]
