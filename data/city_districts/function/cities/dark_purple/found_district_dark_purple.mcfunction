...
tag @n[type=minecraft:armor_stand] add cd_dist_dark_purple
...
execute at @p run function city_districts:cities/dark_purple/show_title_dark_purple
...
tellraw @e[type=player,distance=..1000] [{"text":"[CD] ","color":"dark_aqua"},{"nbt":"CustomName","entity":"@e[type=armor_stand, tag=cd_dist_dark_purple, sort=nearest, limit=1]","interpret":"true","color":"dark_purple"}, {"text":" has been founded by ","color":"dark_aqua"}, {"selector":"@p","color":"dark_aqua"}, {"text":"!","color":"dark_aqua"}]
