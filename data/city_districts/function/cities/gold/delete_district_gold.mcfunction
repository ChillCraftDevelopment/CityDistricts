...
tellraw @e[type=player,distance=..1000] [{"text":"[CD] ","color":"dark_aqua"},{"selector":"@n[type=armor_stand, tag=cd_dist_gold]","color":"gold"}, {"text":" has been discontinued... ","color":"dark_aqua"}]
