...
tag @n[type=minecraft:armor_stand] add cd_dist_gold
...
execute at @p run function city_districts:cities/gold/show_title_gold
...
tellraw @e[type=player,distance=..1000] [{"text":"[CD] ","color":"dark_aqua"},{"nbt":"CustomName","entity":"@e[type=armor_stand, tag=cd_dist_gold, sort=nearest, limit=1]","interpret":"true","color":"gold"}, {"text":" has been founded by ","color":"dark_aqua"}, {"selector":"@p","color":"dark_aqua"}, {"text":"!","color":"dark_aqua"}]
