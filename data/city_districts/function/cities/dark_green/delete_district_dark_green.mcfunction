...
tellraw @e[type=player,distance=..1000] [{"text":"[CD] ","color":"dark_aqua"},{"selector":"@n[type=armor_stand, tag=cd_dist_dark_green]","color":"dark_green"}, {"text":" has been discontinued... ","color":"dark_aqua"}]
