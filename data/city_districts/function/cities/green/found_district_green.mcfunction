...
tag @n[type=minecraft:armor_stand] add cd_dist_green
...
execute at @p run function city_districts:cities/green/show_title_green
...
tellraw @e[type=player,distance=..1000] [{"text":"[CD] ","color":"dark_aqua"},{"nbt":"CustomName","entity":"@e[type=armor_stand, tag=cd_dist_green, sort=nearest, limit=1]","interpret":"true","color":"green"}, {"text":" has been founded by ","color":"dark_aqua"}, {"selector":"@p","color":"dark_aqua"}, {"text":"!","color":"dark_aqua"}]
