...
tag @n[type=minecraft:armor_stand] add cd_dist_gray
...
execute at @p run function city_districts:cities/gray/show_title_gray
...
tellraw @e[type=player,distance=..1000] [{"text":"[CD] ","color":"dark_aqua"},{"nbt":"CustomName","entity":"@e[type=armor_stand, tag=cd_dist_gray, sort=nearest, limit=1]","interpret":"true","color":"gray"}, {"text":" has been founded by ","color":"dark_aqua"}, {"selector":"@p","color":"dark_aqua"}, {"text":"!","color":"dark_aqua"}]
